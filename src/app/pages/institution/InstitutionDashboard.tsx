...
export default function InstitutionDashboard() {
  ...
  const stats = [
    ...
    { label: 'Propostas recebidas', value: overview?.proposals ?? 0, icon: Inbox, to: '/instituicao/propostas' },
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="grid lg:grid-cols-2 gap-4">
            ...
            {[
              {
                ...
                description: 'Garanta nome e localização estruturada antes de publicar novos sonhos.',
                to: '/instituicao/pacientes',
              },
              {
                title: 'Publicar sonhos com contexto claro',
                description: 'Descreva o desejo do beneficiário e o nível de urgência para melhorar a conexão com apoiadores.',
                to: '/instituicao/sonhos/criar',
              },
              {
                title: 'Acompanhar propostas e conversas',
                description: 'Centralize resposta institucional para manter histórico e segurança.',
        ...
        <div className="bg-white border border-indigo-100 rounded-2xl p-5 space-y-4">
          ...
          <div className="space-y-3">
            {[
              'Os sonhos publicados aparecem para apoiadores como casos acompanhados pela instituição.',
              'As propostas recebidas ficam centralizadas na sua fila de avaliação.',
              'Quando uma proposta é aceita, a conversa institucional passa a ser o canal oficial do caso.',
            ].map((item) => (
