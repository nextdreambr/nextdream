...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#fff8f6_0%,#f7f1ed_100%)] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <p className="text-gray-500 text-sm leading-relaxed mb-8">
          A página que você está buscando não existe ou foi movida. Você pode voltar ao início
          ou retornar para a página anterior.
        </p>
