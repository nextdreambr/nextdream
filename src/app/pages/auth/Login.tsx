    ...
    <div className="min-h-screen bg-pink-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-gray-800" style={{ fontWeight: 700, fontSize: '1.5rem' }}>Bem-vindo de volta</h1>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-pink-100 p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="flex justify-end mt-1.5">
                <Link to="/esqueci-senha" className="text-xs text-pink-600 hover:text-pink-700">Esqueci a senha</Link>
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-pink-600 hover:bg-pink-700 text-white py-3.5 rounded-xl font-semibold flex items-center justify-center gap-2 transition-colors"
            >
              {loading ? (
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 border border-gray-200 rounded-xl py-3 text-sm text-gray-600 hover:bg-gray-50 transition-colors">
